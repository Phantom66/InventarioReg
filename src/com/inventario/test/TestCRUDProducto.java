...
public class TestCRUDProducto {
	...
	public static void main(String[] args) {
		...
		// Producto producto = new Producto(0,"Estante","En Buen Estado"," Oficina
		// Principal");
		...
		// Producto productoDos = new Producto(2, "Estante", "En Buen Estado", " Oficina
		// Principal");
		// ActualizarProducto
		...
		/*
		 * ListarTodosLosProductos List<Producto> p = proDao.buscarTodos();
		 * 
		 * for (Producto e: p) {
		 * 
		 * System.out.println("Nombre: " + e.getNombre() + " Estatus: " +
		 * e.getEstatus());
		 * 
		 * }
		 */
